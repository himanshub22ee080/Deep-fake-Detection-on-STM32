...
/******************************************************************************/
#define AI_DEEP_MODEL_NAME          "deep"
#define AI_DEEP_ORIGIN_MODEL_NAME   "deepfake_detection_quantized"

/******************************************************************************/
#define AI_DEEP_ACTIVATIONS_ALIGNMENT   (4)
#define AI_DEEP_INPUTS_IN_ACTIVATIONS   (4)
#define AI_DEEP_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_DEEP_IN_NUM        (1)

AI_DEPRECATED
#define AI_DEEP_IN \
  ai_deep_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_DEEP_IN_SIZE { \
  AI_DEEP_IN_1_SIZE, \
}
#define AI_DEEP_IN_SIZE_BYTES { \
  AI_DEEP_IN_1_SIZE_BYTES, \
}
#define AI_DEEP_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_DEEP_IN_1_HEIGHT      (96)
#define AI_DEEP_IN_1_WIDTH       (96)
#define AI_DEEP_IN_1_CHANNEL     (3)
#define AI_DEEP_IN_1_SIZE        (27648)
#define AI_DEEP_IN_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_DEEP_OUT_NUM       (1)

AI_DEPRECATED
#define AI_DEEP_OUT \
  ai_deep_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_DEEP_OUT_SIZE { \
  AI_DEEP_OUT_1_SIZE, \
}
#define AI_DEEP_OUT_SIZE_BYTES { \
  AI_DEEP_OUT_1_SIZE_BYTES, \
}
#define AI_DEEP_OUT_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_DEEP_OUT_1_CHANNEL     (1)
#define AI_DEEP_OUT_1_SIZE        (1)
#define AI_DEEP_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_DEEP_N_NODES (18)
 ...
 * @ref ai_deep_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_DEEP_*
 * defines into file @ref deep.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
